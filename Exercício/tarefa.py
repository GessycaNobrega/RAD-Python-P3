#Implemente um script em Python que realize as seguintes operações: Leia o conteúdo de um arquivo de texto.

#Escreva o conteúdo lido em um novo arquivo, adicionando uma linha de cabeçalho.
