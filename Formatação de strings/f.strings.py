# Para definimos uma variável f-string, precisamos incluir, antes das aspas que definem uma string, a letra f (ou F), por exemplo: minha_string = f”Olá Mundo {expr}”
